...
<a href="https://git.io/typing-svg"><img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=50&pause=500&color=F78A13&center=true&random=false&width=1000&height=100&lines=NoirDeveloper" alt="Typing SVG" /></a>
**`Programer`**

<p align="left">
   Привіт!! Я Артем, мені 15 років, ще навчаюсь в школі, але вже маю велики амбіції та плани.

   Тут ви побачете багато цікавого:\n
    1. Мій мессенджер з End to End шифруфанням,\n
    2. Модуль для розробки телеграм ботів (на python),\n
    3. Та ще багато чого цікавого!
   ...
   <p align="left">
      ...
      <a href="https://github.com/noirdeveloper?tab=followers">
      ...
      <a href="https://github.com/noirdeveloper?tab=repositories&sort=stargazers">
